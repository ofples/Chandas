// Config plugin for the local slot-timer-service module.
//
...
//   "plugins": [["./modules/slot-timer-service/app.plugin.js"]]

const { withMainActivity } = require('@expo/config-plugins')
const { CodeGenerator } = require('@expo/config-plugins')

const HELPER_IMPORT = 'import expo.modules.slottimerservice.AlarmWindowHelper'
const INTENT_IMPORT = 'import android.content.Intent'

function withSlotTimerAlarmMainActivity(config) {
  return withMainActivity(config, config => {
    ...
    src = CodeGenerator.mergeContents({
      ...
      tag: 'slottimer-alarm-intent-import',
    ...
    src = CodeGenerator.mergeContents({
      ...
      tag: 'slottimer-alarm-helper-import',
    ...
    src = CodeGenerator.mergeContents({
      ...
      tag: 'slottimer-alarm-onnewintent',
...
module.exports = withSlotTimerAlarmMainActivity

...
- Never run builds locally on this computer. It does not have enough resources for them.
- Do not run Gradle build or compile tasks, `expo run:android`, `expo run:ios`, local EAS builds, `expo export`, Android Studio builds, or Xcode builds.
